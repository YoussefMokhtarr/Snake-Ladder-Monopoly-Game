...
public:
	...
	bool verticalcheck(CellPosition startCell,CellPosition endCell);
	...
	void CanBeEdited (Card*&pCard,CellPosition&cardPosition);
	...
	void SetCurrentPlayerNum(int=0);
	// ========= Other Getters =========
	...
	int countLadder();//count the ladders
	int countSnake();//count the snake
	int countCard();//count the card
