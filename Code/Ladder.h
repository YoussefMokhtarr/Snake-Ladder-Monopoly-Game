...
public:
	...
	virtual void Save(ofstream& OutFile, Type t) ;	// Saves the Ladder parameters to the file
	virtual void Load(ifstream& InFile);// loads the Ladder parameters to the file
